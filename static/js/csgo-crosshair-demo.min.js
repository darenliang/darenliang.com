...
d=[];for(const [c,l]of b)null!==l&&d.push(`${c}=${l}`);e.src=`${"https://crosshair.darenliang.com/"}?${d.join("&")}`}};m();let g=null;window.copyLink=()=>{navigator.clipboard.writeText(e.src).then(()=>{h.innerText="Copied";null===g&&(g=setTimeout(()=>{h.innerHTML="Copy";g=null},2E3))})};window.updatePreview=m})();
